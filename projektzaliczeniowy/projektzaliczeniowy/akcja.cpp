...
t1(700, 600, " ", Color::White, 30), t2(100, 200, " ", Color::White,30), dystans(0), t3(400, 30, "", Color::White, 30), t4(200, 300, "", Color::White, 30),
...
t5(200, 350, "kajzerka", Color::White, 30), n1(0,0,"nakladka_przepis.png"), kajzerka(20,16,3,1,1,2,"kajzerka.png","guzik_plus.png", "guzik_minus.png"),
...
woda(20,796, "woda.png", "guzik_plus.png", "guzik_minus.png")
{}
...
void akcja::obsluga_zdarzen(Event& e, RenderWindow& okno)
{
	...
	if (e.type == Event::MouseButtonPressed && e.mouseButton.button == Mouse::Left)
	{
		...
		{
			if (kajzerka.moznaUpiec(maka,woda, mleko, z1) && z1.maka >= maka.liczba_do_wypieczenia && z1.drozdze >= drozdze.liczba_do_wypieczenia && z1.mleko >= mleko.liczba_do_wypieczenia)
			{
