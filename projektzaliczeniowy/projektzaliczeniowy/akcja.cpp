...
t5(200, 350, "kajzerka", Color::White, 30), n1(0,0,"nakladka_przepis.png"), kajzerka(20, 406, 1, 1, 1, 2, "kajzerka.png", "guzik_plus.png", "guzik_minus.png", true),
...
, maka(20, 16, "flour.png", "guzik_plus.png", "guzik_minus.png", true), chlebek(20, 69, 4,1,1,2, "chleb.png", "guzik_plus.png", "guzik_minus.png", true),
mleko(20, 276, "milk.png", "guzik_plus.png", "guzik_minus.png", true), drozdze(20, 536, "drozdzebabuni.png", "guzik_plus.png", "guzik_minus.png", true),
chalka(20,1417,2,1,1,3,"chalka.png", "guzik_plus.png", "guzik_minus.png", false),
precel(20,1080,1,1,1,3,"precel.png", "guzik_plus.png", "guzik_minus.png", false), rogalik(20,743,4,1,1, 5, "rogal.png", "guzik_plus.png", "guzik_minus.png", true),
woda(20,796, "woda.png", "guzik_plus.png", "guzik_minus.png", true),jajka(20,16,"egg.png", "guzik_plus.png", "guzik_minus.png", true),maslo(20, 1056,"maslo.png", "guzik_plus.png", "guzik_minus.png", false)
...
void akcja::obsluga_zdarzen(Event& e, RenderWindow& okno)
{
	...
	if (e.type == Event::MouseButtonPressed && e.mouseButton.button == Mouse::Left)
	{
		...
		{
			if (n1.g1.p1(pozycjamyszy))
			{
				if (z1.ostatniKlik == z1.Gora || z1.ostatniKlik == z1.Brak)
				{
					if (z1.licznikGora < z1.maxKlikniec)
					{
						przewinPrzepisy(-337);
						z1.licznikGora++;
						z1.ostatniKlik = z1.Gora;
						if (z1.licznikDol > 0)
						{
							z1.licznikDol--;
						}
			...
			if (n1.g2.p1(pozycjamyszy))
			{
				if (z1.ostatniKlik == z1.Dol)
				{
					if (z1.licznikDol < z1.maxKlikniec)
					{
						przewinPrzepisy(337);
						z1.licznikDol++;
...
void akcja::wyswietl(RenderWindow& okno)
{
	...
	else
	{
		...
		{
			for (skladnik* i : skladniki_widoczne)
			{
				if (i->widoczny)
					i->rysujskladnik(okno);
			}
			okno.draw(t3.nap);
			okno.draw(t2.nap);
			okno.draw(t6.nap);
