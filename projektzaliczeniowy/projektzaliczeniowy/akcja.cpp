...
using namespace sf;
	...
	int x;
akcja::akcja(petla& p1, zmienne& z1) :p1(p1), z1(z1), g1(100, 100, "tg1.png", "tg1.png"), o1(800, 700, "klient.png"), o2(0, 0, "bakery_background.png"), t1(600, 650, " "), t2(200, 200, " "), dystans(0), t3(200, 250, ""), t4(200, 300, ""), g2(800, 150, "tg1.png", "tg1.png"), g3(100, 10, "tg1.png","tg1.png"), t5(200, 350, "kajzerka")
{
...
//	if (dystans >= 200 && dystans <= 750 && sprzedane)
//	{
//		o1.guzikson.move(-100 * dt, 0); //add move func
//		dystans = dystans + 100 * dt;
//		t1.nap.setString(" ");
...
//	{
//		sprzedane = false;
//		o1.guzikson.setPosition(800, 700); // add set position func
//		dystans = 0;
//		losowanie = false;
//		losowanie2 = false;
//	}
